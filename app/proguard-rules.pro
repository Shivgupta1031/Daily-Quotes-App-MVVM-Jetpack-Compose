...
-keep class com.devshiv.dailyquotes.model.** { *; }
-keepclassmembers class com.devshiv.dailyquotes.model.** { *; }

-keep class com.devshiv.dailyquotes.viewmodels.** { *; }
-keep class com.devshiv.dailyquotes.repository.** { *; }